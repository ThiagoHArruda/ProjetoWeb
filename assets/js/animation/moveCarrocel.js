export class moveCarrocel {
    static mover() {
        const botaoDireito = document.querySelectorAll(".catalogo__carrocel-botaoDireito")
        const botaoEsquerdo = document.querySelectorAll(".catalogo__carrocel-botaoEsquerdo")
        let girar = new Array();
